...
sections:
  ...
  - block: markdown
    ...
    content:
      ...
      align_right: true
      text: |-
        - **Synopsys Inc., Synopsys Headquarters — R&D Engineer Intern (May–December 2025):** researched machine-learning-based signal-integrity analysis for 2.5D ICs by evaluating multiple models and independently implemented two C++ prototypes into the main branch.
